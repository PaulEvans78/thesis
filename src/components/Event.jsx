        ...
        <StyledEventMain> 
                ...
                <StyledEvent ref={contentRef} isInView={isInView}>
                    ...
                    <StyledAboutEvent>
                        ...
                        <p>Ligament tears, patellar dislocations, and meniscal injuries are frequent, 
                            requiring proper diagnosis and treatment for players to return to the game safely. In the seminar you will gain: </p>
                    
                        <li>Understanding how elite physios work with LipusPlus </li>
                        <li>Latest research findings on LIPUS </li>
                        <li>How our Return To Play concept can help your club and athletes recover faster </li>                           
                    </StyledAboutEvent>
                            ...
                            <StyledHostContainer>
                                ...
                                <StyledImgContainer>
                                    <StyledHostImg src={hostImg} alt="Physiotherapist Sebastian Carnefeldt." />
                                </StyledImgContainer>

                                    <StyledIdent>                                            
                                        <h6>Broadcasted LIVE only</h6>
                                        <p>Hosted by Sebastian Carnefelt, Lic. Chiropractor at LipusPlus Institute.</p>
                                    </StyledIdent>
