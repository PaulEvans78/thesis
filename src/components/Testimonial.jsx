  ...
  useEffect(() => {
    ...
    return (
        ...
        <StyledTestimonialMain > 
                ...
                <StyledImg src={testimonialImage} alt="A hammarby handball player in green and white stripes holds a ball." />
            ...
            <StyledTestimonialGrid>
                ...
                <StyledTestimonialContents ref={contentRef} isInView={contentInView}>
                    ...
                    <h2>
                    “With the LipusPlus®, I can take charge of my own rehabilitation and recovery, enhancing my life as an athlete. 
                    It's the game-changer that keeps me in top shape. Without it I’d probably not play in the same extent that I do”.  
                    </h2>

                    <p>
                        - Martin Dolk, Hammarby Handball
                    </p>
                    ...
                    <StyledLogoContainer>
                            ...
                            <StyledLogoImg src={partnershipLogo} alt="The hammarby handball logo. A yellow wreath with a green and white stripped flag in the middle with the letters H I F. "/>
                        ...
                        <p>
                        Fri 30th August, 2024 between 18.00 - 19.00 CET.
                        </p>

                        <h2>
                        How LipusPlus® speeds up rehabilitation and recovery among athletes.
                        </h2>
